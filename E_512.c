...
int E_512( uint8_t h[], uint8_t N[], uint8_t m[]){
    ...
    uint8_t C_2[] ={0x6f, 0xa3, 0xb5, 0x8a, 0xa9, 0x9d, 0x2f, 0x1a, 0x4f, 0xe3, 0x9d, 0x46, 0x0f, 0x70, 0xb5, 0xd7,
    ...
    uint8_t C_3[] ={0xf5, 0x74, 0xdc, 0xac, 0x2b, 0xce, 0x2f, 0xc7, 0x0a, 0x39, 0xfc, 0x28, 0x6a, 0x3d, 0x84, 0x35,
    ...
    uint8_t C_4[] ={0xef, 0x1f, 0xdf, 0xb3, 0xe8, 0x15, 0x66, 0xd2, 0xf9, 0x48, 0xe1, 0xa0, 0x5d, 0x71, 0xe4, 0xdd,
    ...
    uint8_t C_5[] ={0x4b, 0xea, 0x6b, 0xac, 0xad, 0x47, 0x47, 0x99, 0x9a, 0x3f, 0x41, 0x0c, 0x6c, 0xa9, 0x23, 0x63,
    ...
    uint8_t C_6[] ={0xae, 0x4f, 0xae, 0xae, 0x1d, 0x3a, 0xd3, 0xd9, 0x6f, 0xa4, 0xc3, 0x3b, 0x7a, 0x30, 0x39, 0xc0,
    ...
    uint8_t C_7[] ={0xf4, 0xc7, 0x0e, 0x16, 0xee, 0xaa, 0xc5, 0xec, 0x51, 0xac, 0x86, 0xfe, 0xbf, 0x24, 0x09, 0x54,
    ...
    uint8_t C_8[] ={0x9b, 0x1f, 0x5b, 0x42, 0x4d, 0x93, 0xc9, 0xa7, 0x03, 0xe7, 0xaa, 0x02, 0x0c, 0x6e, 0x41, 0x41,
    ...
    uint8_t C_9[] ={0x37, 0x8f, 0x5a, 0x54, 0x16, 0x31, 0x22, 0x9b, 0x94, 0x4c, 0x9a, 0xd8, 0xec, 0x16, 0x5f, 0xde,
    ...
    uint8_t C_10[]={0xab, 0xbe, 0xde, 0xa6, 0x80, 0x05, 0x6f, 0x52, 0x38, 0x2a, 0xe5, 0x48, 0xb2, 0xe4, 0xf3, 0xf3,
    ...
    uint8_t C_11[]={0x7b, 0xcd, 0x9e, 0xd0, 0xef, 0xc8, 0x89, 0xfb, 0x30, 0x02, 0xc6, 0xcd, 0x63, 0x5a, 0xfe, 0x94,
    ...
    uint8_t C_12[]={0x37, 0x8e, 0xe7, 0x67, 0xf1, 0x16, 0x31, 0xba, 0xd2, 0x13, 0x80, 0xb0, 0x04, 0x49, 0xb1, 0x7a,
    ...
    //__1_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_1, K);               //|
    //__________________________//|
    //__2_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_2, K);               //|
    //__________________________//|
    //__3_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_3, K);               //|
    //__________________________//|
    //__4_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_4, K);               //|
    //__________________________//|
    //__5_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_5, K);               //|
    //__________________________//|
    //__6_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_6, K);               //|
    //__________________________//|
    //__7_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_7, K);               //|
    //__________________________//|
    //__8_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_8, K);               //|
    //__________________________//|
    //__9_Итерация______________//|
    LPSX(K, m);                 //|
    LPSX(C_9, K);               //|
    //__________________________//|
    //__10_Итерация_____________//|
    LPSX(K, m);                 //|
    LPSX(C_10, K);              //|
    //__________________________//|
    //__11_Итерация_____________//|
    LPSX(K, m);                 //|
    LPSX(C_11, K);              //|
    //__________________________//|
    //__12_Итерация_____________//|
    LPSX(K, m);                 //|
    LPSX(C_12, K);              //|
    //__________________________//|
    //__13_Итерация_____________//|
    X_512(K, m);                //|
    //__________________________//|
    return 0;
}